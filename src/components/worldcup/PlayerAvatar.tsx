...
import { buildPlayerPhotoCandidates, playerInitials, positionColor, positionAbbrev } from '../../utils/playerPhoto';
...
export function PlayerAvatar({
  ...
  const candidates = useMemo(
    ...
    [photo, photoUrl, provider, providerPlayerId, apiFootballId, theSportsDbId],
  );
