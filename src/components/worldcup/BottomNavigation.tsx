...
import { Home, Shield, Play, Target, User, type LucideIcon } from 'lucide-react'
            ...
            {({ isActive }) => (
              <>
                {featured ? (
                  <div className="wc26-bottom-nav__cta-wrap">
                    ...
                    <motion.span
                      ...
                      whileHover={reduceMotion ? undefined : { scale: 1.04, y: -14 }}
                      animate={{ y: -14, scale: isActive ? 1.06 : 1 }}
                      transition={spring}
                    >
                      <span className="wc26-bottom-nav__cta-shine" aria-hidden />
                      <span className="wc26-bottom-nav__cta-gloss" aria-hidden />
                      <Icon className="wc26-bottom-nav__cta-icon" strokeWidth={2.4} aria-hidden />
                    </motion.span>
                  </div>
                ) : (
                  <>
                ...
                <motion.span
                  ...
                  animate={{
                    opacity: isActive ? 1 : featured ? 0.92 : 0.58,
                    y: isActive ? 0 : 1,
                  }}
